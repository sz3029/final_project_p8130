...
The observation #6 is an outlier in all three
...
```
The observation #123, #6 is identified
...
```{r}
model_1_new = lm(crm_1000 ~ totalinc + poverty + hsgrad + beds_density + docs_density + region + pop_density, data = crime_after)

model_2_new = lm(crm_1000 ~ pop18 + hsgrad + bagrad + poverty + pcincome + 
    totalinc + region + pop_density + beds_density, data = crime_after)

model_3_new = lm(crm_1000 ~ pop18 + hsgrad + bagrad + poverty + pcincome + 
    totalinc + region + pop_density + beds_density, data = crime_after)
...
```{r}
model_1 = lm(crm_1000 ~ totalinc + poverty + hsgrad + beds_density + docs_density + region + pop_density + bagrad*poverty + + pcincome*region, data = crime_after)

model_2 = lm(crm_1000 ~ pop18 + hsgrad + bagrad + poverty + pcincome + 
    totalinc + region + pop_density + beds_density + bagrad*poverty + poverty*region, data = crime_after)

model_3 = lm(crm_1000 ~ pop18 + hsgrad + bagrad + poverty + pcincome + 
    totalinc + region + pop_density + beds_density + bagrad*poverty, data = crime_after)
