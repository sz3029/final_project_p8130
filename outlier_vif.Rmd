...
```{r candidate_models}
model_1 = lm(crm_1000 ~ totalinc + poverty + hsgrad + beds_density + docs_density + region + pop_density + bagrad*poverty, data = crime_df)
...
```{r backward_adj}
crime_df %>%
  filter(row(crime_df) == 6 | row(crime_df) == 123| row(crime_df) == 215)
...
```{r}
model_1 = lm(crm_1000 ~ totalinc + poverty + hsgrad + beds_density + docs_density + region + pop_density + bagrad*poverty, data = crime_after)
