...
```{r candidate_models}
model_1 = lm(crm_1000 ~ totalinc + poverty + beds_density + beds_density + region + pop_density + docs_density*totalinc + docs_density*beds_density, data = crime_df)
...
```{r}
model_1_new = lm(crm_1000 ~ totalinc + poverty + beds_density + beds_density + region + pop_density, data = crime_after)
